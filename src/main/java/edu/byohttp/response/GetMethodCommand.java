...
public class GetMethodCommand implements Command{
    ...
    public GetMethodCommand(ResourceManagerImpl resourceManager,ResponseFactory responseFactory, NotFoundResponseHandler notFoundResponseHandler){
    ...
    public Response execute(Request request) {
        ...
        if (searchedResource.isEmpty()){
            ...
            return responseFactory.getResponse(HttpResponseStatusCode.OK,request.getProtocolVersion(),headersResponseMap, Optional.of(foundResource.getResourceBytes()));
        }
    }
}
